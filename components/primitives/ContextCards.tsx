...
const CHUNKS = [
  {
    ...
    body: "Migrations must run before the app rolls out; hold the release if the health check fails twice in a row.",
    source: "Deploy Runbook.pdf",
    badge: "PDF",
    tone: "bg-red",
  },
  {
    title: "Weekly metrics export",
    chars: "1,250 characters",
    body: "WAU +18%, activation +6%, free-tier churn -11%; flag any cohort dropping below 40% week-two retention.",
    source: "Metrics Export.csv",
    badge: "CSV",
    tone: "bg-green",
  },
];
