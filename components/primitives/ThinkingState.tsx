...
> = {
  Steps: {
    ...
    rows: [
      ...
      { primary: "Gathering relevant context" },
      { primary: "Analyzing the data", secondary: "6 sources" },
      { primary: "Drafting a response" },
    ],
  },
  Reasoning: {
    active: "Thinking",
    ...
    rows: [
      {
        primary:
          "The metrics point to a churn spike concentrated in the free tier late in the quarter.",
      },
      {
        primary:
          "I should confirm the cohort sizes before attributing the drop to onboarding.",
      },
    ],
  },
  Search: {
    ...
    rows: [
      {
        primary: "Next.js Docs",
        secondary: "nextjs.org",
  ...
  Coding: {
    ...
    rows: [
      { primary: "Read", secondary: "app/page.tsx", mono: true },
      { primary: "Edit", secondary: "chat-panel.tsx", mono: true, add: 74, del: 41 },
