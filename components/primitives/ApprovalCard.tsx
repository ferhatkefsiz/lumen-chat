...
const QUESTIONS = [
  {
    q: "How should we ship v0.3?",
    type: "radio" as const,
    options: ["Full rollout", "Canary at 10%", "Behind a flag"],
  },
  {
    q: "Which checks must pass first?",
    type: "check" as const,
    options: ["Unit tests", "E2E suite", "Type check"],
  },
  {
    q: "Who signs off on the release?",
    type: "radio" as const,
    options: ["Eng lead", "On-call engineer", "The whole team"],
  },
];
