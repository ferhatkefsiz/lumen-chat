...
const SOURCES: Source[] = [
  ...
  { key: "codebase", name: "Codebase", desc: "Search your repositories", glyph: "chart" },
  { key: "docs", name: "Project docs", desc: "Specs, RFCs and runbooks", glyph: "layers" },
...
const COMMANDS = [
  { key: "explain", name: "/explain", desc: "Explain this code or error" },
  { key: "review", name: "/review", desc: "Review a diff or file" },
  { key: "tests", name: "/tests", desc: "Generate unit tests" },
  { key: "refactor", name: "/refactor", desc: "Refactor for clarity" },
  { key: "summarize", name: "/summarize", desc: "Digest the thread so far" },
];

const MODELS = [
  { key: "lumen-5", name: "Lumen 5", tag: "Flagship" },
  { key: "lumen-air", name: "Lumen Air", tag: "Balanced" },
  { key: "lumen-mini", name: "Lumen Mini", tag: "Fast" },
];

const FILES = ["schema.prisma", "api-spec.yaml", "metrics.csv"];
const DICTATION = "Summarize the open pull requests";
...
const AUTO_STEPS: {
  ...
  { draft: "", connect: false, model: "lumen-air", hold: 1100 },
